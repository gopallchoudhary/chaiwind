...
const npmInstall = `npm install chaiwind`;

const npmImport = `import "chaiwind";`;
      ...
      {tab === "npm" ? (
        <div className="space-y-4">
          <p className="text-[var(--muted-foreground)]">
            Add the package, then import once in your entry file so utilities are
            registered.
          </p>
        ...
        <div className="space-y-4">
          <p className="text-[var(--muted-foreground)]">
            Load the library as an ES module (for example in static HTML or a simple
            Vite page without a bundler step).
          </p>
